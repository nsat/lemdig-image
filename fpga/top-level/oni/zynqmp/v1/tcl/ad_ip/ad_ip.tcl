...
proc adi_ip_create {ip_name} {
  ...
  create_project $ip_name $::env(TOP_SRC_DIR)/tmp/$ip_name -part $target_device -force

  set ip_constr_files ""
  set lib_dirs $::env(TOP_SRC_DIR)/hdl
...
proc adi_ip_properties_lite {ip_name} {
  ...
  set output_ip_dir $::env(TOP_SRC_DIR)/hdl/$ip_name

  ipx::package_project -root_dir $output_ip_dir -vendor analog.com -library user -taxonomy /Analog_Devices -import_files
